...
import { getCubes, getMufts, getPolyLines } from "../../../Redux/map/mapSelectors"
        ...
        {polyLines?.map((item, index) => {
            ...
            return <Polyline
                ...
                eventHandlers={{
                    ...
                    click: (e) => PolylineInterface.handleOnClickPolyline(e, dispatch, item, map, polyLines, cubes, index, mufts),

                    mouseover: (e) => PolylineInterface.handleMouseOverPolyline(e, dispatch, item, drag, index, polyLines, mufts),

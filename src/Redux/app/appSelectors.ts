...
export const getGeneralMenu = (state: RootState) => state.app.menuOpen;
...
export const getItemId = (state: RootState) => state.app.id;
...
export const getMuftaMenuOpen = (state: RootState) => state.app.muftaMenuOpen;
export const getPolylineMenuOpen = (state: RootState) => state.app.polylineMenuOpen;
export const getContextMenuX = (state: RootState) => state.app.contextMenuX;
export const getContextMenuY = (state: RootState) => state.app.contextMenuY;
export const getItemMenu = (state: RootState) => state.app.itemMenu;
export const getCubes = (state: RootState) => state.app.cubes;
